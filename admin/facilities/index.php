...
<link rel="stylesheet" href="../css/facilities-index.css">
...
<div class="modal fade" id="addFacilityModal" tabindex="-1">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form
                action="../../backend/facilities_add_process.php"
                method="POST"
...
<div class="modal fade" id="editFacilityModal" tabindex="-1">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form
                action="../../backend/facilities_edit_process.php"
                method="POST"
                enctype="multipart/form-data">
...
.forEach(button => {
    ...
    button.addEventListener('click', function(){
        ...
        let facilityId = this.dataset.id;

        Swal.fire({

            title: 'Delete Facility?',
            text: 'This facility will be permanently removed.',
            icon: 'warning',
