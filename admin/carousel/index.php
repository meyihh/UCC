...
<div class="modal fade" id="addCarouselModal" tabindex="-1">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form
                action="../../backend/carousel_add_process.php"
                method="POST"
...
<div class="modal fade" id="editCarouselModal" tabindex="-1">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form
                action="../../backend/carousel_edit_process.php"
                method="POST"
                enctype="multipart/form-data">
...
.forEach(button => {
    ...
    button.addEventListener('click', function(){
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: 'You are about to delete this carousel slide.',
            icon: 'warning',
