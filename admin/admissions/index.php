...
<div class="modal fade" id="addAdmissionModal" tabindex="-1">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form
                action="../../backend/admission_add_process.php"
                method="POST"
...
<div class="modal fade" id="editAdmissionModal" tabindex="-1">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form
                action="../../backend/admission_edit_process.php"
                method="POST"
                enctype="multipart/form-data">
...
.forEach(button => {
    ...
    button.addEventListener('click', function(){
        ...
        let admissionId = this.dataset.id;

        Swal.fire({

            title: 'Delete Admission?',
            text: 'This admission will be permanently removed.',
            icon: 'warning',
